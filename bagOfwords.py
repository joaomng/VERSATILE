...
def saveCSVFromBagOfWords(arq, bagOfWords,targetFile):
    ...
    #Todo: fazer uma lista ordenada por frequência das palavras e escrever
    #csv através da ordem da lista

    sorted_x = sorted(bagOfWords.items(), key=operator.itemgetter(1)) 
